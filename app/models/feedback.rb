class Feedback < ActiveRecord::Base
  ...
  validates :please_comment, presence: true, length: {maximum: 500, minimum: 5}
  validates :feel_well_informed, presence: true
  validates :wish_to_be_contacted, presence: true
  validates :involved_in_forum, presence: true
